...
router.put('/:id', (req, res) => {
    ...
    Memo.findById(req.params.id, (err, memo) => {
        ...
        memo.contents = sanitizer.escape(req.body.contents);
...
router.put('/star/:id', (req, res) => {
    ...
    Memo.findById(req.params.id, (err, memo) => {
        ...
        const index = memo.starred.indexOf(username);

        // CHECK WHETHER THE USER ALREADY HAS GIVEN A START
        const hasStarred = (index === -1) ? false : true;
